...
if(!conString)
  conString = 'postgres:localhost:5432/kilovolt'; //Done! TODO: Don't forget to set your own conString
//Connection string for windows user.
//conString = `postgres://postgres:${PG_PASSWORD}@localhost:5432/kilovolt`
